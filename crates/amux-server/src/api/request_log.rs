...
pub const ROUTE_TABLE: &[RouteEntry] = &[
    RouteEntry { path: "/api/connection/security", methods: &["GET"] },
    RouteEntry { path: "/api/connection/session", methods: &["POST"] },
    RouteEntry { path: "/api/connection/certificate", methods: &["POST"] },
    ...
    RouteEntry { path: "/api/projects", methods: &["GET"] },
    RouteEntry { path: "/api/projects/{name}", methods: &["GET", "PUT"] },
    RouteEntry { path: "/api/projects/{name}/migration/preview", methods: &["POST"] },
    RouteEntry { path: "/api/projects/{name}/commands", methods: &["POST"] },
    RouteEntry { path: "/api/projects/{name}/legacy-receipts/{id}/cancel", methods: &["POST"] },
    RouteEntry { path: "/api/projects/{name}/commands/{id}/retry", methods: &["POST"] },
    RouteEntry { path: "/api/projects/{name}/tasks/{id}/report", methods: &["POST"] },
