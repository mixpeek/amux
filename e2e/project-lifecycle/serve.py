...
parser=argparse.ArgumentParser();parser.add_argument('--binary',required=True);parser.add_argument('--home');parser.add_argument('--port',type=int,default=18964);a=parser.parse_args()
...
(home/'server.env').write_text('ANTHROPIC_API_KEY=fixture-not-a-credential\n')
